...
// Hardhat comes with a number of tasks, and we can also add our custom tasks. They can be written in 'hardhat.config.js' file, but we will make a seperte folder called 'tasks' in the root of the project and then add our tasks there. This will keep our code clean and organized.
...
//This custom task will not show up in the list of hardhat tasks when you run 'yarn hardhat'. We'll have to add it to the 'hardhat.config.js' file:
