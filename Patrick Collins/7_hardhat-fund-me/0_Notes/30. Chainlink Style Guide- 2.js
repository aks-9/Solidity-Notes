//* Chainlink Style Guide- 2

// This is './test/unit/FundMe.js' file.

//* Updating the varible names for 'private' variables.
...
describe('FundMe', function () {
    ...
    describe('constructor', function () {
        it('Sets the aggregator address correctly', async function () {
            const response = await fundMe.getPriceFeed(); //updating variable names.
    ...
    describe('fund', function () {
        ...
        it('Updates the amount funded in the data structure', async function () {
            ...
            const response = await fundMe.getAddressToAmountFunded(deployer); //updating variable names.
    ...
    describe('withdraw', function () {
        ...
        it('withdraw ETH when we have multiple funders', async function () {
            ...
            await expect(fundMe.getFunder(0)).to.be.reverted; //updating variable names.
            for (i = 1; i < 6; i++) {
                assert.equal(
        ...
        it('Cheaper withdraw multiple testing...', async function () {
            ...
            for (i = 1; i < 6; i++) {
                assert.equal(
                    await fundMe.getAddressToAmountFunded(accounts[i].address), //updating variable names.
                    0
                );
            }
        });
