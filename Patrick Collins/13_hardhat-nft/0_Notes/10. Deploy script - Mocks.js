//* 10. Deploy script - Mocks

// Since we're working with VRF coordinator, create a new file in the 'deploy' folder and add a new file ' 00-deploy-mocks.js' in it. We can also copy and paste from our earlier project. comment out the part of 'MockV3Aggregator' as we are not using it currently.
