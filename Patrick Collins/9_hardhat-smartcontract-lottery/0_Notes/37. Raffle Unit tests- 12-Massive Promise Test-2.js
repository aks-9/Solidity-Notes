//* Raffle Unit tests- 12

// This  is 'Raffle.test.js' file.

//* Massive Promise Test-2
      ...
      describe('fulfillRandomWords', function () {
        ...
        it('picks a winner, resets, and sends money', async () => {
          ...
          await new Promise(async (resolve, reject) => {
            ...
            const tx = await raffle.performUpkeep([]); // passing empty bytes object.
            const txReceipt = await tx.wait(1);
            await vrfCoordinatorV2Mock.fulfillRandomWords(
              txReceipt.events[1].args.requestId,
              raffle.address
            ); //events[1] because it will be the second event with index= 1

            // Now 'fulfillRandomWords' function is called, it should emit 'WinnerPicked' event, and our 'listener' will be triggered, and execute the code in its arrow function.
          });
        });
      });
    });
