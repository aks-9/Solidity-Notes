//* Raffle Unit tests- 13

// This  is 'Raffle.test.js' file.

//* Massive Promise Test-3
        ...
        it('picks a winner, resets, and sends money', async () => {
          ...
          await new Promise(async (resolve, reject) => {
            raffle.once('WinnerPicked', async () => {
              console.log('Found the event'); // now we jump to try block for 'asserts'.
              try {
                // Now that a winner has been picked.
                ...
                // 's_players' array should be reset to 0. So if we call getNumberOfPlayers, it should be 0.
                const numPlayers = await raffle.getNumberOfPlayers();
                assert.equal(numPlayers.toString(), '0');

                // Raffle state should be back to being 'Open'.
                assert.equal(raffleState.toString(), '0');

                assert(endingTimestamp > startingTimeStamp); // because the 'lastTimeStamp' should be updated.
                resolve();
              } catch (e) {
                reject(e);
              }
...
yarn hardhat test --grep "picks a winner, resets, and sends money"
  ...
  Raffle unit tests
    fulfillRandomWords
Found the event
0x70997970C51812dc3A010C7d01b50e0d17dc79C8 //*Winner is account[1]
0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266
0x70997970C51812dc3A010C7d01b50e0d17dc79C8 // account[1]
0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC
0x90F79bf6EB2c4f870365E785982E1f101E93b906
      ✔ picks a winner, resets, and sends money (4281ms)
